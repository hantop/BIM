...
insert  into `directory`(`id`,`directoryName`,`directoryCode`,`directoryPriority`,`directoryType`,`directoryIcon`,`parentNavigator`,`consoleUrl`) values (1,'系统管理',NULL,NULL,1,NULL,0,NULL),(2,'角色管理',NULL,NULL,1,NULL,1,'/roleIndex.shtml'),(3,'用户管理',NULL,NULL,1,NULL,1,'/staffIndex.shtml'),(14,'人员管理',NULL,NULL,1,NULL,0,NULL),(15,'施工队伍',NULL,NULL,1,NULL,14,'/workTeam.shtml'),(16,'管理人员',NULL,NULL,1,NULL,14,'/worker.shtml'),(17,'授权中心',NULL,NULL,1,NULL,0,NULL),(18,'正式授权',NULL,NULL,1,NULL,17,'/workCard.shtml?empower=0'),(19,'临时授权',NULL,NULL,1,NULL,17,'/workCard.shtml?empower=1'),(20,'门区管理',NULL,NULL,1,NULL,17,'/workCardArea.shtml'),(21,'发卡统计',NULL,NULL,1,NULL,17,'/workCardStatistics.shtml'),(22,'培训管理',NULL,NULL,1,NULL,0,NULL),(23,'安全培训',NULL,NULL,1,NULL,22,'/cultivate.shtml'),(24,'劳务记录',NULL,NULL,1,NULL,0,NULL),(25,'不良记录',NULL,NULL,1,NULL,24,'/workerRecord.shtml?rtype=0'),(26,'奖励记录',NULL,NULL,1,NULL,24,'/workerRecord.shtml?rtype=1'),(27,'工时管理',NULL,NULL,1,NULL,0,NULL),(28,'队伍工时',NULL,NULL,1,NULL,27,'/workerCardRecord.shtml'),(29,'黑名单',NULL,NULL,1,NULL,24,'/blackRecord.shtml'),(30,'工资发放',NULL,NULL,1,NULL,27,'/wages.shtml'),(31,'宿舍管理',NULL,NULL,1,NULL,0,NULL),(32,'楼栋展示',NULL,NULL,1,NULL,31,'/floor.shtml'),(33,'房间展示',NULL,NULL,1,NULL,31,'/room.shtml'),(34,'床位展示',NULL,NULL,1,NULL,31,'/bed.shtml');
...
/*Table structure for table `work_card` */

DROP TABLE IF EXISTS `work_card`;
...
CREATE TABLE `work_card` (
  ...
  `cardType` varchar(5) DEFAULT NULL COMMENT '卡类型0=ic',
  `cardTime` datetime DEFAULT NULL COMMENT '制卡日期',
  `remark` varchar(500) DEFAULT NULL COMMENT '备注',
  `effective` datetime DEFAULT NULL COMMENT '有效时间',
  `lifeArea` varchar(5) DEFAULT NULL COMMENT '授权生活区',
  `workArea` varchar(5) DEFAULT NULL COMMENT '授权工作区',
  `empower` varchar(5) DEFAULT NULL COMMENT '0=正式授权1=临时授权',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

/*Data for the table `work_card` */
