            ...
            <div class="ibox">
	            <div class="ibox-title">
	                ...
	                <div class="ibox-tools">
                        <button type="button" class="btn btn-w-m btn-primary" data-toggle="modal" data-target="#add_team"><i class="fa fa-user-plus"></i> 添加楼宇</button>
                    </div>
            	</div>
    	...
    	<div class="modal-dialog">
       	    <form id="addTeamForm" class="modal-content animated fadeIn" novalidate="novalidate">
           	   <div class="modal-header">
                    ...
                    <h4 class="modal-title text-left">新增楼宇</h4>
                  </div>
                <div class="modal-body">
					<div class="form-horizontal ">
					      <div class="form-group"><div class="col-sm-12">
							<label class="col-sm-3 control-label"><span class="form-valid-field" >*</span>楼宇名称：</label>
		                    <div class="col-sm-8">
		                        <input type="text" class="form-control" name="floor" id="floor" data-rule-required="true"  data-rule-rangelength="[2,12]">
		                    </div></div>
		                </div>

					    <div class="form-group"><div class="col-sm-12">
							<label class="col-sm-3 control-label"><span class="form-valid-field"  >*</span>层数：</label>
		                    <div class="col-sm-8">
								<input type="text" class="form-control" name="layer" id="layer" data-rule-required="true" data-rule-rangelength="[1,5]" >

							</div></div>
		                </div>

					    <div class="form-group"><div class="col-sm-12">
							<label class="col-sm-3 control-label"><span class="form-valid-field"  >*</span>房间数：</label>
		                    <div class="col-sm-8">
		                        <input type="text" class="form-control" name="room" id="room" data-rule-required="true" data-rule-rangelength="[1,5]" >
		                        
		                    </div></div>
		                </div>

						<div class="form-group"><div class="col-sm-12">
							<label class="col-sm-3 control-label"><span class="form-valid-field"  >*</span>床数：</label>
							<div class="col-sm-8">
								<input type="text" class="form-control" name="bed" id="bed" data-rule-required="true" data-rule-rangelength="[1,5]" >
	...
	<div class="modal inmodal" id="edit_staff" role="dialog" aria-hidden="true" data-backdrop="static" style="display: none;">
    	<div class="modal-dialog">
       	   <form id="editTeamForm" class="modal-content animated fadeIn" novalidate="novalidate" >
           	   <div class="modal-header">
                    <button type="reset" class="close" data-dismiss="modal"><span aria-hidden="true">×</span><span class="sr-only">Close</span></button>
                    <h4 class="modal-title text-left">添加房间</h4>
                  </div>
                <div class="modal-body">
					<div class="form-horizontal ">
					     <div class="form-group"><div class="col-sm-12">
							<label class="col-sm-3 control-label"><span class="form-valid-field">*</span>楼层：</label>
		                    <div class="col-sm-8">

								<select class="form-control" name="layerId" id="layerId" data-rule-required="true"  data-live-search="true">
									<option value="">请选择楼层...</option>
									<option value="1" hassubinfo="true">1层</option>
									<option value="2" hassubinfo="true">2层</option>
									<option value="3" hassubinfo="true">3层</option>
									<option value="4" hassubinfo="true">4层</option>
									<option value="5" hassubinfo="true">5层</option>
									<option value="6" hassubinfo="true">6层</option>
								</select>
		                    </div></div>
		                </div>
						...
						<div class="form-group">
							<div class="col-sm-12">
								<label class="col-sm-3 control-label"><span class="form-valid-field">*</span>房间名称：</label>
								<div class="col-sm-8">
					    ...
					    <div class="form-group">
							<div class="col-sm-12">
								<label class="col-sm-3 control-label"><span class="form-valid-field">*</span>床位数：</label>
			                    <div class="col-sm-8">
			                        <input type="text" class="form-control" name="bed" id="beds">
    	...
    	function installGrid(){
    		$("#datatable").jqGrid({
    			...
    			columns : [ 
    			    ...
    			    {field : "layer",title: '总层数',width : "10%",align: 'center',valign: 'middle'},
    			    {field : "room",title: '总房间数',width : "10%",align: 'center',valign: 'middle'},
                    {field : "bed",title: '总床位数',width : "10%",align: 'center',valign: 'middle'},
                    {field : "mobile",title: '已入住数',width : "10%",align: 'center',valign: 'middle'},
                    {field : "mobile",title: '入住比率',width : "10%",align: 'center',valign: 'middle'},
    			    {field : "operate",title : "操作",width : "10%",align: 'center',valign: 'middle',
    			    	formatter:function(value,row,index){
    						return   "<a href='javascript:void(0);' class='edit_party'>添加房间</a>&nbsp;"
