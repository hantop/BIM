    	...
    	<div class="modal-dialog">
       	   <form id="editTeamForm" class="modal-content animated fadeIn" novalidate="novalidate" >
           	   <div class="modal-header">
                    ...
                    <h4 class="modal-title text-left">添加入住</h4>
                  </div>
    	...
    	function installGrid(){
    		$("#datatable").jqGrid({
    			...
    			columns : [ 
                    ...
                    {field : "room",title: '床位',width : "10%",align: 'center',valign: 'middle'},
                    {field : "mobile",title: '入住人员',width : "10%",align: 'center',valign: 'middle'},
                    {field : "mobile",title: '性别',width : "10%",align: 'center',valign: 'middle'},
                    {field : "mobile",title: '工种',width : "10%",align: 'center',valign: 'middle'},
                    {field : "mobile",title: '班组',width : "10%",align: 'center',valign: 'middle'},
                    {field : "mobile",title: '入住日期',width : "10%",align: 'center',valign: 'middle'},
    			    {field : "operate",title : "操作",width : "15%",align: 'center',valign: 'middle',
    			    	formatter:function(value,row,index){
    						return   "<a href='javascript:void(0);' class='edit_party'>入住</a>&nbsp;"
    								+"<a href='javascript:void(0);' class='remove_party'>&nbsp;取消</a>";
    				    },
    				    events:{
