...
<body>
	<div class="wrapper wrapper-content animated fadeInRight">
		...
		<!-- 查询条件 -->
            ...
            <div class="ibox">
	            <div class="ibox-title">
                	<h5><c:if test="${empower eq 0}">正式</c:if>
						<c:if test="${empower eq 1}">临时</c:if>授权管理</h5>
	                <div class="ibox-tools">
                        <button type="button" class="btn btn-w-m btn-primary" data-toggle="modal" data-target="#add_team">
							<i class="fa fa-user-plus"></i> 添加
							<c:if test="${empower eq 0}">正式</c:if>
							<c:if test="${empower eq 1}">临时</c:if>授权</button>
                    </div>
            	</div>
       	    ...
       	    <form id="addTeamForm" class="modal-content animated fadeIn" novalidate="novalidate">
           	   <div class="modal-header">
				   ...
				   <h4 class="modal-title text-left">新增
					   <c:if test="${empower eq 0}">正式</c:if>
					   <c:if test="${empower eq 1}">临时</c:if>授权
				   </h4>
                  </div>
                <div class="modal-body">
					<div class="form-horizontal ">
					      <div class="form-group"><div class="col-sm-12">
							<label class="col-sm-3 control-label"><span class="form-valid-field" >*</span>卡号：</label>
		                    <div class="col-sm-8">
		                        <input type="text" class="form-control" name="cardNum" id="cardNum" >
								<input type="hidden" class="form-control" name="empower" id="empower" value="${empower}"/>
		                    </div></div>
		                </div>
						<div class="form-group"><div class="col-sm-12">
							<label class="col-sm-3 control-label"><span class="form-valid-field" >*</span>卡类型：</label>
							<div class="col-sm-8">
								<select class="form-control" name="cardType" id="cardType" data-rule-required="true"  data-live-search="true">
						...
						<div class="form-group"><div class="col-sm-12">
							<label class="col-sm-3 control-label"><span class="form-valid-field" >*</span>制卡日期：</label>
							<div class="col-sm-8">
								<input type="text" class="form-control" name="cardTime" id="cardTime" value="2018-06-10">
							</div></div>
						</div>

						<div class="form-group"><div class="col-sm-12">
							<label class="col-sm-3 control-label"><span class="form-valid-field" >*</span>有效时间：</label>
							<div class="col-sm-8">
								<input type="text" class="form-control" name="effective" id="effective" value="2018-12-12">
							</div></div>
						</div>

						<div class="form-group"><div class="col-sm-12">
							<label class="col-sm-3 control-label"><span class="form-valid-field" >*</span>授权区：</label>
							<div class="col-sm-8">
								<input type="checkbox" name="lifeArea" id="lifeArea" value="1" checked="checked" /> 生活区
								<input type="checkbox" name="lifeArea" id="workArea" value="1" checked="checked" /> 施工区
							</div></div>
						</div>
						...
						<div class="form-group"><div class="col-sm-12">
							<label class="col-sm-3 control-label"><span class="form-valid-field"  >*</span>入住人员：</label>
							<div class="col-sm-8">
    	...
    	function installGrid(){
    		$("#datatable").jqGrid({
    			...
    			columns : [ 
                    ...
                    {field : "empower",title: '授权',width : "10%",align: 'center',valign: 'middle'},
    			    {field : "cardNum",title : "卡号",width : "10%",align: 'center',valign: 'middle'},
    			    {field : "cardType",title: '卡类型',width : "10%",align: 'center',valign: 'middle'},
    			    {field : "cardTime",title: '制卡日期',width : "10%",align: 'center',valign: 'middle'},
    			    {field : "effective",title: '有效时间',width : "10%",align: 'center',valign: 'middle'},
                    {field : "realName",title: '姓名',width : "5%",align: 'center',valign: 'middle'},
                    {field : "realName",title: '班组',width : "10%",align: 'center',valign: 'middle'},
                    {field : "realName",title: '工种',width : "10%",align: 'center',valign: 'middle'},
                    {field : "lifeArea",title: '生活区',width : "5%",align: 'center',valign: 'middle'},
                    {field : "workArea",title: '工作区',width : "5%",align: 'center',valign: 'middle'},
